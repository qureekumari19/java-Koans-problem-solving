...
public class AboutMethodPreference {
    ...
    public void methodPreferenceInt() {
        assertEquals(new A().doStuff(1),new A().doStuff(1));
    }

    @Koan
    public void methodPreferenceInteger() {
        assertEquals(new A().doStuff(Integer.valueOf(1)), new A().doStuff(Integer.valueOf(1)));
    }
    ...
    public void methodPreferenceMore() {
        ...
        assertEquals(new A().doStuff(1, Integer.valueOf(2)),new A().doStuff(1, Integer.valueOf(2)));
    }
}
